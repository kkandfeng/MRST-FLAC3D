%% This file only calculates the paper mill, and Liu Jiagou Group and Shi Qianfeng calculate it in a separate file, which is convenient for different hole pressures
clc; clear;
...
p_ref   = 20 *mega*Pascal;                      % reference pressure
t_ref   = 103+273.15;                            % reference temperature
...
poro(             1 : n_onelayer*16) = 0.015;
poro(n_onelayer*16+1 : n_onelayer*36) = 0.15;
...
perm = ones(G.cartDims)*10.0;
perm(             1 : n_onelayer*16) = 0.1;
perm(n_onelayer*16+1 : n_onelayer*36) = 10;
...
% Setup the well
wc1 = 70 * 70 * 35 + 70*30 + 31;       
inj_rate1 = 1e8 / year / co2_rho; 
W = [];
...
initState.pressure = repmat(20e6 , Gt.cells.num, 1);
...
save('ZhiFang_mrst_sol.mat','Gt','states');
